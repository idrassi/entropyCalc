...
signtool sign /v /sha1 85AA2E55CFB9C38FE474C58B38E9521450CD9306 /ac DigiCert_Assured_ID_Code_Signing_CA.cer /fd sha1 /t http://timestamp.digicert.com "..\bin\entropyCalc.exe" "..\bin\entropyCalc-x64.exe" "..\bin\entropyCalc-arm64.exe" "..\bin\entropyCalc-arm.exe"
